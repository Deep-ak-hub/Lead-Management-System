...
const CreateAdmin = () => {
  ...
  return (
    <>
      <form
        className="mx-4 bg-white/5 text-white p-6 rounded-lg"
      ...
      >
        ...
        <div className="flex flex-col my-3">
          ...
          <input
            ...
            aria-required
            name="email"
            className="p-2 outline-0 focus:ring bg-white focus:ring-primary rounded"
          />
        </div>
        <div className="flex flex-col my-3">
          ...
          <input
            ...
            required
            name="password"
            className="rounded p-2 outline-0 focus:ring bg-white focus:ring-primary"
          />
        </div>
        <div className="flex flex-col my-3">
          ...
          <select
            name="purchasedPlan"
            onChange={handleChange}
            className="rounded p-2 outline-0 focus:ring focus:ring-primary bg-white"
          >
