        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                to="/request"
                className="px-6 py-2 bg-primary text-white rounded-lg font-semibold shadow-lg shadow-purple-500/50"
              >
                Sign Up
              </Link>
            </div>
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24">
          <div className="text-center">
            ...
            <h1 className="text-6xl md:text-7xl font-bold text-white mb-6 leading-tight">
              Track Every Lead,
              <br />
              <span className="text-white">Close Every Deal</span>
            </h1>
            <p className="text-xl text-purple-200 mb-12 max-w-3xl mx-auto leading-relaxed">
              Manage clients and students effortlessly. Track projects, courses,
              and opportunities in one powerful platform designed for growth.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-purple-500/50 hover:bg-white/10 transition-all duration-300 hover:scale-105">
            ...
            <p className="text-purple-200 leading-relaxed">
              Organize all your contacts in one place. Track clients for
              projects and students for courses with customizable fields and
              tags.
            </p>
          </div>
          ...
          <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-purple-500/50 hover:bg-white/10 transition-all duration-300 hover:scale-105">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">
              Project & Course Tracking
            </h3>
            <p className="text-purple-200 leading-relaxed">
              Assign multiple projects to clients or courses to students.
              Monitor progress, deadlines, and deliverables effortlessly.
            </p>
          </div>
          ...
          <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-purple-500/50 hover:bg-white/10 transition-all duration-300 hover:scale-105">
            ...
            <p className="text-purple-200 leading-relaxed">
              Visualize your sales funnel from lead to conversion. Get insights
              on conversion rates, revenue forecasts, and performance metrics.
            </p>
          </div>
          ...
          <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-purple-500/50 hover:bg-white/10 transition-all duration-300 hover:scale-105">
            ...
            <p className="text-purple-200 leading-relaxed">
              Set up automated follow-ups, reminders, and status updates. Save
              time with smart automation that works while you focus on closing
              deals.
            </p>
          </div>
          ...
          <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-purple-500/50 hover:bg-white/10 transition-all duration-300 hover:scale-105">
            ...
            <p className="text-purple-200 leading-relaxed">
              Generate detailed reports on leads, conversions, and revenue.
              Export data and share insights with your team in real-time.
            </p>
          </div>
          ...
          <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-purple-500/50 hover:bg-white/10 transition-all duration-300 hover:scale-105">
            ...
            <p className="text-purple-200 leading-relaxed">
              Enterprise-grade security with encrypted data storage. Your leads
              and sensitive information are always protected and backed up.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="relative rounded-3xl p-12 md:p-16 overflow-hidden">
          ...
          <div className="relative text-center">
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Join thousands of businesses already growing with LeadFlow Pro.
              Start your 14-day free trial today.
            </p>
            <Link
              to="/request"
              className="px-10 py-5 bg-white text-purple-600 rounded-xl font-bold text-lg hover:bg-purple-500 transition-all duration-300 shadow-xl hover:scale-105"
            >
              Sign up
            </Link>
          </div>
